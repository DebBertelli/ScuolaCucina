...
<body>
	...
	<div class="dx" style="padding-top: 60px">
		...
		<form style="display: inline-block;" action="preferiti-servlet">
			<input type="hidden" name="azione" value="svuota"> <input
				type="submit" value="svuota" class="trasparente"
				style="width: auto; text-decoration: underline">
		</form>
					...
					<div class="elimina">
						<form action="preferiti-servlet">
							<input type="hidden" name="id" value="<%=c.getId()%>"> <input
								type="hidden" name="azione" value="rimuovi"> <input
